...
ITEM=$(mktemp)
{
    cat <<EOF
    <item>
      <title>Louver v$VERSION</title>
      <link>https://github.com/domus-apps/louver/releases/tag/v$VERSION</link>
...
EOF
    ...
    cat <<EOF
      ...
      <enclosure
        url="https://github.com/domus-apps/louver/releases/download/v$VERSION/Louver.zip"
        $SIGNATURE_ATTRS
